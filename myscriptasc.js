...
locArray.sort(function (a, b) { return b.dateCreated.localeCompare(a.dateCreated) === 0 ? b.timeCreated.localeCompare(a.timeCreated) : b.dateCreated.localeCompare(a.dateCreated); });
console.table(locArray);
